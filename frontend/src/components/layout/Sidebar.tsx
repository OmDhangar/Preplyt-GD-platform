...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "bg-bg-dark text-text-on-dark min-h-[calc(100vh-4rem)] py-6 px-3 border-r border-hairline-dark flex flex-col transition-all duration-300 relative shrink-0",
